...
<?= $this->section('content') ?>
    ...
    <div class="container">
        <div class="col-md-12 col-xs-12" style="background: #f5f5f5;">
            <h3>Edit Slider</h3>
            <br>
            <?php echo form_open_multipart('manage_slider/edit/'.$data->id); ?>
            <?= csrf_field() ?>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-xs-12">
                    ...
                    <small>Recommended: ukuran gambar 1300x480 pixel</small>
                    <br>
                    <img src="<?php echo base_url('public/uploads/slider/'.$data->img) ?>" style="max-width:100%"/>
                </div>
            </div>
            <br>
            <div class="row">
