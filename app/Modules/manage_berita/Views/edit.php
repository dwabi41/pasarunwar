...
<?= $this->section('content') ?>
    ...
    <div class="container">
        <div class="col-md-12 col-xs-12" style="background: #f5f5f5;">
            <h3>Edit Berita</h3>
            <br>
            <?php echo form_open_multipart('manage_berita/edit/'.$data->id); ?>
            <?= csrf_field() ?>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-xs-12">
                    ...
                    <br>
                    <img src="<?php echo base_url('public/uploads/berita/'.$data->img) ?>" style="max-width:100%"/>
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-md-10 col-xs-12">
                    <input name="caption" type="text" class="form-control" value="<?php echo $data->caption; ?>"/>
                </div>
            </div>
            <br>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-xs-12">
                    <input name="keyword" type="text" class="form-control" value="<?php echo $data->keyword; ?>"/>
                </div>
            </div>
            <br>
            <div class="row">
