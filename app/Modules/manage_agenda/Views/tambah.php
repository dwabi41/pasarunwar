...
<?= $this->section('content') ?>
    ...
    <div class="container">
        <div class="col-md-12 col-xs-12" style="background: #f5f5f5;">
            <h3>Tambah Agenda</h3>
            <br>
            <?php echo form_open_multipart('manage_agenda/tambah','id = frmmenus'); ?>
            <?= csrf_field() ?>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-12">
                    ...
                    <div class='input-group date' id='datetimepicker2'>
                        <input name="end_date" type='text' class="form-control" VALUE="<?php echo old('end_date'); ?>" />
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-calendar"></span>
                        </span>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-xs-12">
                    <input name="time" type="text" class="form-control" value="<?php echo old('time'); ?>"/>
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-md-10 col-xs-12">
                    <input name="place" type="text" class="form-control" value="<?php echo old('place'); ?>"/>
                </div>
            </div>
            <br>
            <div class="row">
